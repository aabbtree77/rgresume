...
\projecturl{https://github.com/aabbtree77/initialsdb}
...
\begin{itemize}
\item \murl{https://github.com/aabbtree77/law2}
...
Rewrote firmware (C, avr-gcc) for the paper cutting machine, ensuring correctness and precision under heavy factory workloads, with some updates throughout the years. The machine is still in use today (2026).
