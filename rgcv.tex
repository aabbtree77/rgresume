...
MERN            &
  \murl{https://github.com/aabbtree77/aabbtree77.github.io}\\
                &  
...
SQLite          &
  \murl{https://github.com/aabbtree77/schatzhauser}\\
                &
...
\begin{tabularx}{\textwidth}{@{}p{3cm}>{\raggedright\arraybackslash}X@{}}
   ...
   Favorite Art & The Cold Heart (1827), \textrussian{Бесы (1872)}, The Last Leaf (1905), \textlithuanian{Balta drobulė (1958)}, Le jouet (1976), \textrussian{Девочка и дельфин (1979)}, Marie Baie des Anges (1997)         
\end{tabularx}
%
