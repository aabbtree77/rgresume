...
\begin{tabularx}{\textwidth}{@{}p{3cm}>{\raggedright\arraybackslash}X@{}}
        ...
        Favorite Art  & \textdanish{Ole Rømer}: $c = 2.2 \times 10^{8}\,\text{m/s}$ (1676)\\                       
                      & The Nutcracker and the Mouse King (1816)\\
                      & Arago Spot (1818)\\
                      & The Cold Heart (1827)\\
                      & \textrussian{Пиковая дама (1834)}\\
                      & The Steadfast Tin Soldier (1838), The Little Match Girl (1845)\\
                      & Toilers of the Sea (1866)\\
                      & \textrussian{Идиот (1869)}, \textrussian{Бесы (1872)}\\
                      & Sophus Lie (1888)\\
                      & Hunger (1890)\\ 
                      & The Nutcracker (1892)\\
                      & \textrussian{Пётр Лебедев (1899)}\\ 
                      & The Last Leaf, The Gift of the Magi (1905)\\
                      & \textlithuanian{Senelės} pasaka (1937)\\
                      & Balta \textlithuanian{drobulė} (1958)\\
                      & Pound - Rebka (1960)\\
                      ...
                      & \textlithuanian{Nuodėmės užkalbėjimas} (2007)\\
                      & \textlithuanian{Išgyventi vasarą} (2018)\\
                      & Vilniaus romansas (2021)\\
                      & How Electricity Actually Works (Veritasium, 2022)\\
                      & \textlithuanian{Ašies kodas} (2022)\\
                      & \textlithuanian{Kodėl Tu Čia?} (2023)\\
                      & \textlithuanian{Saugok širdį} (2024)
\end{tabularx}
%
