...
Tools: VPS, ssh, Linux, git, Porkbun, Go, React, Postgres, SQLite, sqlc, Makefile, Dockerfile, docker-compose.yml, Tailwind, Excalidraw, Mermaid. Also tried: MongoDB Atlas, render.com, MaxMind Geolocation, MERN, Drizzle ORM, Astro.
