...
LaTeX           & 
  \murl{https://aabbtree77.github.io/tensors}
\end{tabularx}
...
\begin{tabularx}{\textwidth}{@{}p{3cm}>{\raggedright\arraybackslash}X@{}}
   ...
   Other Interests & Math, physics, literature. The 19th century mostly. Much cinema and music, a bit of PC games (Until Dawn, INSIDE, Spintires, GTA4)\\
   & Hauff, Andersen, \textrussian{Достоевский}, O. Henry, lost gen, \textlithuanian{Škėma}, Dibdin, Charles Bukowski. Picnic at Hanging Rock, Le jouet, \textrussian{Девочка и дельфин}, La piovra, Twin Peaks, Marie Baie des Anges, Buffalo '66.          
\end{tabularx}
%
