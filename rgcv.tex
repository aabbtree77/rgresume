...
HTML, CSS, Js:  & \url{https://github.com/aabbtree77/law2}\\
         & \url{https://github.com/aabbtree77/miniguestlog}         
\end{tabular}
%
\section{Selected Bug Reports}
\begin{tabular}{ll}
Ported C++ code to Linux: & \url{https://github.com/Max1412/Graphics2/issues/24}\\
Fixed uint vs uint32 bug: & \url{https://github.com/go-gl/gl/issues/128}\\
Fixed screen tearing: & \url{https://github.com/godlikepanos/anki-3d-engine/issues/59}\\
Provided a test for deep copying: & \url{https://github.com/polydojo/jispy/issues/1}\\
%\multicolumn{2}{c}{In addition: Matlab, Scilab, LaTeX, Markdown.}
Compared raw wine to dxvk: & \url{https://github.com/doitsujin/dxvk/issues/3789}
\end{tabular}
%
...
\begin{tabular}{ll}
        ...
        Highest chess Elo:& 2267 (Blitz on lichess.org, 04.02.2024).\\
